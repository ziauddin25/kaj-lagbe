...
(0, _mocha.describe)('parsePhoneNumberWithError', function () {
  (0, _mocha.it)('should parse phone numbers', function () {
    ...
    (0, _chai.expect)(parsePhoneNumberFull('Phone: 8 (800) 555 35 35.', 'RU').getType()).to.equal('TOLL_FREE');
  });
  (0, _mocha.it)('shouldn\'t set country when it\'s non-derivable', function () {
    var phoneNumber = parsePhoneNumber('+7 111 555 35 35');
    (0, _chai.expect)(phoneNumber.country).to.be.undefined;
    (0, _chai.expect)(phoneNumber.countryCallingCode).to.equal('7');
    (0, _chai.expect)(phoneNumber.nationalNumber).to.equal('1115553535');
  });
  (0, _mocha.it)('should parse carrier code', function () {
    var phoneNumber = parsePhoneNumber('0 15 21 5555-5555', 'BR');
    (0, _chai.expect)(phoneNumber.carrierCode).to.equal('15');
  });
  (0, _mocha.it)('should parse phone extension', function () {
    var phoneNumber = parsePhoneNumber('Phone: 8 (800) 555 35 35 ext. 1234.', 'RU');
    (0, _chai.expect)(phoneNumber.ext).to.equal('1234');
  });
  (0, _mocha.it)('should validate numbers for countries with no type regular expressions', function () {
    (0, _chai.expect)(parsePhoneNumber('+380391234567').isValid()).to.equal(true);
    (0, _chai.expect)(parsePhoneNumber('+380191234567').isValid()).to.equal(false);
  });
  (0, _mocha.it)('should format numbers', function () {
    var phoneNumber = parsePhoneNumber('Phone: 8 (800) 555 35 35.', 'RU');
    (0, _chai.expect)(phoneNumber.format('NATIONAL')).to.equal('8 (800) 555-35-35');
    (0, _chai.expect)(phoneNumber.formatNational()).to.equal('8 (800) 555-35-35');
    (0, _chai.expect)(phoneNumber.format('INTERNATIONAL')).to.equal('+7 800 555 35 35');
    (0, _chai.expect)(phoneNumber.formatInternational()).to.equal('+7 800 555 35 35');
  });
  (0, _mocha.it)('should get tel: URI', function () {
    var phoneNumber = parsePhoneNumber('Phone: 8 (800) 555 35 35 ext. 1234.', 'RU');
    (0, _chai.expect)(phoneNumber.getURI()).to.equal('tel:+78005553535;ext=1234');
  });
  ...
  (0, _mocha.it)('should throw parse errors', function () {
    (0, _chai.expect)(function () {
  ...
  (0, _mocha.it)('should parse incorrect international phone numbers', function () {
    ...
    (0, _chai.expect)(phoneNumber.nationalNumber).to.equal('8772155230');
    ...
    (0, _chai.expect)(phoneNumber.nationalNumber).to.equal('8800555353');
    (0, _chai.expect)(phoneNumber.country).to.equal('RU');
  });
});
