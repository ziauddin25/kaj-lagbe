...
(0, _mocha.describe)('searchPhoneNumbersInText', function () {
  (0, _mocha.it)('should find phone numbers (with default country)', function () {
    ...
    for (var _iterator = _createForOfIteratorHelperLoose((0, _searchPhoneNumbersInText["default"])('The number is +7 (800) 555-35-35 and not (213) 373-4253 as written in the document.', 'US', _metadataMin["default"])), _step; !(_step = _iterator()).done;) {
      ...
      (0, _chai.expect)(number.number.number).to.equal(NUMBERS[0]);
      NUMBERS.shift();
    }
  });
  ...
  (0, _mocha.it)('should find phone numbers in text', function () {
    ...
    for (var _iterator3 = _createForOfIteratorHelperLoose((0, _searchPhoneNumbersInText["default"])('The number is +7 (800) 555-35-35 and not (213) 373-4253 as written in the document.', 'US', _metadataMin["default"])), _step3; !(_step3 = _iterator3()).done;) {
      ...
      (0, _chai.expect)(number.startsAt).to.equal(expected.startsAt);
      (0, _chai.expect)(number.endsAt).to.equal(expected.endsAt);
      (0, _chai.expect)(number.number.nationalNumber).to.equal(expected.nationalNumber);
      (0, _chai.expect)(number.number.country).to.equal(expected.country);
    }
