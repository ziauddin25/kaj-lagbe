...
function test(text, defaultCountry, expectedNumbers) {
  ...
  while (matcher.hasNext()) {
    ...
    if (phoneNumber.startsAt !== undefined) {
      (0, _chai.expect)(number.startsAt).to.equal(phoneNumber.startsAt);
    }
    if (phoneNumber.endsAt !== undefined) {
      (0, _chai.expect)(number.endsAt).to.equal(phoneNumber.endsAt);
    }
    (0, _chai.expect)(number.number.country).to.equal(phoneNumber.country || defaultCountry);
    (0, _chai.expect)(number.number.nationalNumber).to.equal(phoneNumber.nationalNumber);
  }
  (0, _chai.expect)(expectedNumbers.length).to.equal(0);
}
(0, _mocha.describe)('PhoneNumberMatcher', function () {
  (0, _mocha.it)('should find phone numbers', function () {
  ...
  (0, _mocha.it)('should find phone numbers from Mexico', function () {
  ...
  (0, _mocha.it)('should find phone numbers from Argentina', function () {
  ...
  (0, _mocha.it)('should only support the supported leniency values', function () {
  ...
  (0, _mocha.it)('should validate input parameters', function () {
  ...
  (0, _mocha.it)('should throw when calling `.next()` and there\'s no next match', function () {
  ...
  (0, _mocha.it)('should find phone numbers that are separated by a slash', function () {
    var matcher = new _PhoneNumberMatcher["default"]('651-234-2345/332-445-1234', {
      defaultCountry: 'US',
      v2: true
    }, _metadataMin["default"]);
    (0, _chai.expect)(matcher.hasNext()).to.equal(true);
    var number1 = matcher.next();
    (0, _chai.expect)(number1.startsAt).to.equal(0);
    (0, _chai.expect)(number1.number.number).to.equal('+16512342345');
    (0, _chai.expect)(matcher.hasNext()).to.equal(true);
    var number2 = matcher.next();
    (0, _chai.expect)(number2.startsAt).to.equal(13);
    (0, _chai.expect)(number2.number.number).to.equal('+13324451234');
    (0, _chai.expect)(matcher.hasNext()).to.equal(false);
  });
});
