...
(0, _mocha.describe)('format', function () {
  ...
  (0, _mocha.it)('should work with the first object argument expanded', function () {
    (0, _chai.expect)(formatNumber('2133734253', 'NATIONAL', {
      defaultCountry: 'US'
    })).to.equal('(213) 373-4253');
    (0, _chai.expect)(formatNumber('2133734253', 'INTERNATIONAL', {
      defaultCountry: 'US'
  ...
  (0, _mocha.it)('should sort out the arguments', function () {
    ...
    (0, _chai.expect)(formatNumber('8005553535', 'NATIONAL', _objectSpread(_objectSpread({}, options), {}, {
      defaultCountry: 'RU'
  ...
  (0, _mocha.it)('should format with national prefix when specifically instructed', function () {
    ...
    (0, _chai.expect)(formatNumber('88005553535', 'NATIONAL', {
      defaultCountry: 'RU'
    })).to.equal('8 (800) 555-35-35');
  ...
  (0, _mocha.it)('should work in edge cases', function () {
    ...
    // No suitable format
    (0, _chai.expect)(formatNumber('+121337342530', 'NATIONAL', {
      defaultCountry: 'US'
    })).to.equal('21337342530');
    // No suitable format (leading digits mismatch)
    (0, _chai.expect)(formatNumber('28199999', 'NATIONAL', {
      defaultCountry: 'AD'
    })).to.equal('28199999');
    ...
    // No formats
    (0, _chai.expect)(formatNumber('012345', 'NATIONAL', {
      defaultCountry: 'AC'
    })).to.equal('012345');
